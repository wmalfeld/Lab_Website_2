...
function loadStatsPage()
{
	...
	for (rowCount = 2; rowCount < table.rows.length; rowCount++)
	{
		...
		opposingScore = table.rows[rowCount].cells[3].innerHTML;
		opposingScore = parseInt(opposingScore);

		if(opposingScore > homeScore)
		{
			w = table.rows[rowCount].cells[1].innerHTML;
			losses += 1;
		}
		else{
			w = "CU Boulder";
		...
		table.rows[rowCount].cells[4].innerHTML = w;
	}
...
function loadPlayersPage(playerNum){
	...
	for (i = 0; i < players.length; i++){
		var divy = document.getElementById('player_selector');
...
function switchPlayers(playerNum){
	...
	document.getElementById('avg_p_yards').innerHTML = players[playerNum].receiving_yards/players[playerNum].games_played;
	document.getElementById('avg_r_yards').innerHTML = players[playerNum].receiving_yards/players[playerNum].games_played;
